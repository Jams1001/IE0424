...
# pines acelerometro 
set_property -dict { PACKAGE_PIN F14 IOSTANDARD LVCMOS33 } [get_ports {MOSI}]; #MOSI
set_property -dict { PACKAGE_PIN E15 IOSTANDARD LVCMOS33 } [get_ports {MISO}]; #MISO
set_property -dict { PACKAGE_PIN D15 IOSTANDARD LVCMOS33 } [get_ports {CS}];   #CS
set_property -dict { PACKAGE_PIN F15 IOSTANDARD LVCMOS33 } [get_ports {SCLK}]; #SCLK
